...
const ImageItem = ({ imageSrc, onZoom, onRequestClose, onLongPress, delayLongPress, imageStyle, swipeToCloseEnabled = true, doubleTapToZoomEnabled = true, }) => {
    ...
    return (<ScrollView ref={imageContainer} style={styles.listItem} pagingEnabled nestedScrollEnabled showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} contentContainerStyle={styles.imageScrollContainer} scrollEnabled={swipeToCloseEnabled} {...(swipeToCloseEnabled && {
      ...
      <Animated.View {...panHandlers} style={[
        imageStylesWithOpacity,
        styles.imageContainer
    ]}>
        <Animated.Image source={imageSrc} style={[
        styles.image,
        imageStyle
    ]} resizeMode={'contain'} onLoad={onLoaded}/>
      </Animated.View>
